...
The Hospital Management System (HMS) is a desktop-based application developed using Python, and a backend database powered by MySQL. This system aims to streamline the administrative and operational tasks of hospitals, clinics, or other healthcare facility.
...
![image alt](https://github.com/user-attachments/assets/52bd3891-920d-4272-a9a2-f57e4ee16bad)
